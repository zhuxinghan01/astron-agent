...
class TestHttpRun:
    ...
    def http_run(self):
        ...
        with patch("plugin.link.infra.tool_exector.process.HttpRun.__init__") as mock_init:
            mock_init.return_value = None
            http_run = HttpRun()
            return http_run

    def test_http_run_initialization(self):
...
class TestHttpAuthUtils:
    ...
    def test_assemble_ws_auth_url_functionality(self):
    ...
    def test_public_query_url_functionality(self):
    ...
    def test_auth_url_with_parameters(self):
    ...
    def test_query_url_with_parameters(self):
        ...
        with patch.dict(os.environ, {
            ...
            with patch("plugin.link.infra.tool_exector.http_auth.public_query_url") as mock_query:
                # Mock function with parameters
                mock_query.return_value = "https://api.example.com/query?id=123&type=test"
