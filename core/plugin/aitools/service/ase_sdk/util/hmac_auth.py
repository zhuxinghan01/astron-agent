...
class HMACAuth:
    ...
    @staticmethod
    def build_auth_request_url(request_url: str, method: str = "GET", api_key: str = "", api_secret: str = "") -> str:
        values = HMACAuth.build_auth_params(request_url, method, api_key, api_secret)
        return request_url + "?" + urlencode(values)

    @staticmethod
    def build_auth_params(request_url: str, method: str = "GET", api_key: str = "", api_secret: str = "") -> dict:
    ...
    @staticmethod
    def build_auth_header(request_url: str, method: str = "GET", api_key: str = "", api_secret: str = "") -> dict:
