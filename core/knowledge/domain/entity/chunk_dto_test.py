...
from knowledge.domain.entity.chunk_dto import (
    ...
    QueryMatch, ChunkQueryReq, QueryDocReq
)
...
class TestFileSplitReq:
    ...
    def test_required_fields_valid(self):
        ...
        req = FileSplitReq(file="test content", ragType="AIUI-RAG2")
        assert req.file == "test content"
        assert req.ragType == "AIUI-RAG2"
    ...
    def test_all_fields_valid(self):
        ...
        assert req.ragType == "SparkDesk-RAG"
    ...
    def test_file_empty_validation(self):
        """Test file field empty validation."""
        with pytest.raises(ValidationError) as exc_info:
            FileSplitReq(file="", ragType="AIUI-RAG2")
...
class TestChunkUpdateReq:
    ...
    def test_chunks_must_be_dict(self):
...
class TestChunkDeleteReq:
    ...
    def test_required_fields_only(self):
        ...
        req = ChunkDeleteReq(docId="doc123", ragType="AIUI-RAG2")
        assert req.docId == "doc123"
        assert req.ragType == "AIUI-RAG2"
    ...
    def test_empty_chunk_ids_list(self):
...
class TestQueryMatch:
    ...
    def test_empty_repo_id_validation(self):
    ...
    def test_doc_ids_unique_validation(self):
    ...
    def test_repo_id_unique_validation(self):
    ...
    def test_none_doc_ids_validation(self):
...
class TestChunkQueryReq:
    ...
    def test_nested_match_validation(self):
...
class TestQueryDocReq:
    ...
    def test_valid_creation(self):
        """Test valid creation."""
        req = QueryDocReq(docId="doc123", ragType="AIUI-RAG2")
        assert req.docId == "doc123"
        assert req.ragType == "AIUI-RAG2"

    def test_doc_id_empty_validation(self):
        """Test docId field empty validation."""
        with pytest.raises(ValidationError) as exc_info:
            QueryDocReq(docId="", ragType="AIUI-RAG2")
...
class TestIntegrationCases:
    ...
    def test_chunk_query_with_complex_match(self):
