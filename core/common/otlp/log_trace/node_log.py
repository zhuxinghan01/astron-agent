...
class NodeLog(BaseModel):
    ...
    def set_next_node_id(self, next_id):
        """
        设置下一个节点ID
        :param next_id:
        :return:
    ...
    def set_first_frame_duration(self):
        """
        设置首帧时间
        :return:
        """
    ...
    def set_node_first_cost_time(self, cost_time):
    ...
    def append_output_data(self, key: str, data: Any):
        """
        添加节点输出数据
        :param key:
        :param data:
    ...
    def append_usage_data(self, data: Any):
        """
        添加大模型用户数据
        :param key:
        :param data:
    ...
    def append_config_data(self, data: Dict[str, Any]):
        """
        添加配置数据，主要于节点参数
        :param data:
        :return:
    ...
    def _add_log(self, log_level: str, content: str):
        """
        添加日志
        :param log:
        :return:
