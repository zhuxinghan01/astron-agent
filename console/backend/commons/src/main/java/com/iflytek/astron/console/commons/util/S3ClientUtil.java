...
public class S3ClientUtil {
    ...
    /**
     * Replace endpoint with remoteEndpoint in presigned URL.
     * MinIO client generates URLs using the internal endpoint,
     * but we need to return URLs with the public remoteEndpoint.
     *
