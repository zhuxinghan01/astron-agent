...
//        ApiResult<BotListPageDto> expectedError = new ApiResult<>(400, "Invalid type parameter.", null, null);
//
//        when(agentSquareService.getBotPageByType(eq(-1), anyString(), anyInt(), anyInt())).thenReturn(null);
//
//        ApiResult<BotListPageDto> result = agentSquareController.getBotPageByType(-1, "test", 20, 1);
//
