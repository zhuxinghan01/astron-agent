 ...
 * 
 * This is a simplified encryption/decryption utility class.
 * In actual projects, it should be implemented using the official WeChat encryption/decryption library.
 * 
 * @author xinxiong2
 */
@Slf4j
