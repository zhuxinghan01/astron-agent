...
/**
 * Workflow release service implementation
 * Simplified version: no approval process, direct publish and sync
 */
@Slf4j
@Service
...
public class WorkflowReleaseServiceImpl implements WorkflowReleaseService {
     ...
     * This method calls the workflow service to generate the next version name for a new release
     */
