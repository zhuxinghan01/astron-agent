...
import com.iflytek.astron.console.toolkit.mapper.database.DbTableFieldMapper;
...
public class DatabaseServiceIntegrationTest {
    ...
    private MockedStatic<com.iflytek.astron.console.commons.util.space.SpaceInfoUtil> spaceInfoUtilMock;
    private MockedStatic<com.iflytek.astron.console.toolkit.handler.UserInfoManagerHandler> userInfoMock;

    @BeforeEach
    void setUp() {
        // Mock静态工具类
        spaceInfoUtilMock = mockStatic(com.iflytek.astron.console.commons.util.space.SpaceInfoUtil.class);
        userInfoMock = mockStatic(com.iflytek.astron.console.toolkit.handler.UserInfoManagerHandler.class);

        spaceInfoUtilMock.when(() -> com.iflytek.astron.console.commons.util.space.SpaceInfoUtil.getSpaceId())
                .thenReturn(TEST_SPACE_ID);
        userInfoMock.when(() -> com.iflytek.astron.console.toolkit.handler.UserInfoManagerHandler.getUserId())
